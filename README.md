...
#### 1. **安装步骤**
1. 下载MG Linker(https://gitee.com/yangyachao-X/mg-linker/releases/download/1.0/MG%20Linker.apk)主应用，安装到手机
2. 安装HttpCanary[HttpCanary](https://pan.quark.cn/s/c3582382b19d )抓包工具
3. 按照下方教程进行Token抓包
#### 步骤一
