...
1. **下载安装应用**
   - 下载最新版本的[MG Linke](https://gitee.com/yangyachao-X/mg-linker/releases/download/3.3/MG%20Linker.apk)
   - 在手机上允许安装未知来源应用后完成安装
...
2. **定位请求**
   ...
   - 抓取user_id,user_name:指定接口的返回值中(抓包登录过程): `https://capi-pv.saicmotor.com/app-mp/uais/1.0/quickLoginByVcodeV2`
   - 记录抓包数据
   - token值以-prod_SAIC结尾
3. **获取VIN码**
