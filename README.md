...
1. **下载安装应用**
   - 下载最新版本的[MG Linker](https://gitee.com/yangyachao-X/mg-linker/releases/download/6.5/MG%20Linker.apk)
   - （测试版本下载[MG Linker dev](https://gitee.com/yangyachao-X/mg-linker/releases/download/dev/MG%20Linker.apk)）
   - 在手机上允许安装未知来源应用后完成安装
...
| 版本  | 更新内容                                |
|-----|-------------------------------------|
| 6.5 | 最新版本：1.增加后台服务个性化设置；2.优化蓝牙连接认证异常缓存清理 |
| 5.4 | 界面重构前最后版本                           |
| 3.7 | 桌面带按钮控车最后版本                         |
| 1.0 | 初始版本                                |
